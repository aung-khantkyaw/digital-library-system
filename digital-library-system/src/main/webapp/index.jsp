      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            <img class="h-12 w-auto bg-dark-light rounded-md shadow-sm hover:shadow-md p-1"
      ...
      <div class="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div
            ...
            a revolution in accessing knowledge at your fingertips
          </div>
        </div>
        <div class="text-center">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">
            ...
            Library System.<br />
            Seamlessly access a vast collection of books, articles, and
            multimedia resources anytime, anywhere.<br />
